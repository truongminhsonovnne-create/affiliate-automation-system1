...
export function mapEcomobiItemToOffer(
  ...
  return {
    ...
    discount_value: parseDiscountValue(s.discount ?? s.discount_value),
    max_discount: parseDiscountValue(s.max_discount),
    min_order_value: parseDiscountValue(s.min_purchase ?? s.min_order_value),
    currency: 'VND',
