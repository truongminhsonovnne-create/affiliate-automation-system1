...
const ARTICLES = [
  ...
  },
  {
    ...
    description:
      'Mỗi shop có kho voucher riêng. Tìm đúng mã của cửa hàng bạn muốn mua — thường rẻ hơn mã sàn chung.',
    category: 'Mẹo Hay',
    readTime: 5,
    date: 'Tháng 3, 2026',
  },
  {
    ...
    description:
      'Điểm chất lượng voucher (confidence) giúp bạn biết mã nào đáng tin — giải thích đơn giản không kỹ thuật.',
    category: 'Kiến Thức',
    readTime: 4,
    date: 'Tháng 3, 2026',
  },
  {
    ...
    description:
      'So sánh mã phần trăm, mã cố định, voucher Free Ship để chọn ưu đãi hiệu quả nhất cho từng trường hợp mua hàng.',
    category: 'Kiến Thức',
    readTime: 6,
    date: 'Tháng 3, 2026',
  },
