...
export function ExpiringDealsContent() {
  const { filters, setFilters, response, loading, error, reload } = useExpiringDeals({
    source: 'all', sort: 'expiring', deal_type: '', category: '',
  });
  ...
  return (
    <div>
      <div
        ...
        style={{ background: 'linear-gradient(135deg, #fefce8 0%, #fff 100%)', borderBottom: '1px solid #f3f4f6' }}
      >
        <div className="mx-auto max-w-5xl">
          <div className="mb-3 flex items-center gap-2">
            <Clock className="h-5 w-5" style={{ color: '#d97706' }} />
            <span className="text-xs font-semibold uppercase tracking-wider" style={{ color: '#d97706' }}>Khám phá</span>
          </div>
      ...
      <div className="mx-auto max-w-5xl px-6 py-8 sm:px-10">
        ...
        <div className="mt-6">
          <DealsGrid
            ...
            emptyTitle="Không có deal nào sắp hết hạn" emptySubtitle="Tất cả deals hiện tại còn hiệu lực tốt. Quay lại sau!"
