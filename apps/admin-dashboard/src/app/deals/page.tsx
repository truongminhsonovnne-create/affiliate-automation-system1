 ...
 *
 * Master entry point for all deal discovery.
 * Shows featured hot deals + quick navigation to sub-sections.
 * This is the primary SEO page for the /deals route.
 */
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="relative mx-auto max-w-5xl">
          ...
          <h1 className="text-2xl font-black sm:text-3xl" style={{ color: '#111827', letterSpacing: '-0.02em' }}>
            Deals &amp; Voucher{' '}
            <span style={{ color: '#f97316' }}>Hot Nhất</span>
          </h1>
      ...
      <div className="mx-auto max-w-5xl px-6 py-8 sm:px-10">
        ...
        <section className="mb-8">
          ...
          <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
            <QuickNavCard
              ...
              subtitle="Deals được nhiều người dùng nhất"
              accent="#ef4444"
            />
            <QuickNavCard
              href="/deals/expiring"
            ...
            />
            <QuickNavCard
              href="/deals/source/masoffer"
              icon={Star}
              title="MasOffer"
              subtitle="Deals từ mạng lưới MasOffer"
              accent="#1d4ed8"
            />
            <QuickNavCard
              href="/deals/source/accesstrade"
              icon={TrendingUp}
              title="AccessTrade"
              subtitle="Deals từ AccessTrade"
              accent="#15803d"
            />
          </div>
        </section>
        ...
        <section>
          ...
          <div className="mt-6">
            <DealsGrid
              ...
              loading={loading}
              error={error}
              emptyTitle="Chưa có deal nào phù hợp"
              emptySubtitle="Thử thay đổi bộ lọc hoặc quay lại sau."
              onPageChange={(offset) => reload(offset)}
            />
          </div>
        </section>

        {/* Featured deals by source */}
        {!loading && total > 0 && (
        ...
        {/* Resources strip — internal links from deals to articles */}
        <section className="mt-10" aria-labelledby="resources-heading">
          <div className="mb-5 flex items-center gap-2">
            <h2 id="resources-heading" className="text-sm font-bold" style={{ color: '#6b7280' }}>
              Đọc thêm
            </h2>
          </div>
            ...
            {[
              {
                ...
                desc: 'So sánh mã % và mã cố định để chọn ưu đãi hiệu quả nhất.',
                cat: 'Kiến thức',
              },
              {
                href: '/resources/san-deal-theo-shop',
                title: 'Cách săn deal theo shop',
                desc: 'Tìm voucher riêng của cửa hàng — thường rẻ hơn mã sàn chung.',
                cat: 'Mẹo hay',
              },
              {
                href: '/resources/confidence-score-la-gi',
                title: 'Confidence Score là gì?',
                desc: 'Điểm chất lượng voucher giúp bạn chọn mã đáng tin nhất.',
                cat: 'Kiến thức',
              },
            ].map((item) => (
              <Link
              ...
              >
                <span className="inline-flex w-fit rounded-full bg-gray-50 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-gray-500">
                  {item.cat}
                </span>
        ...
        >
          <div className="flex-1">
            ...
            <p className="mt-1 text-sm" style={{ color: '#6b7280' }}>
              Dán link sản phẩm Shopee/Lazada/Tiki — chúng tôi tìm mã tốt nhất cho bạn.
            </p>
          </div>
          <Link
            href="/home"
