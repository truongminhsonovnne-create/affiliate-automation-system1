 ...
 *
 * Sorted by hotness_score DESC, confidence_score DESC.
 * Shows deals with the highest real engagement (used_count, conversion rate).
 */
    ...
    <div>
      ...
      <div className="mx-auto max-w-5xl px-6 py-8 sm:px-10">
        ...
        >
          ...
          <span>
            Điểm hotness dựa trên số lượt sử dụng và tỷ lệ chuyển đổi thực tế của từng deal.
          </span>
        </div>
        ...
        <div className="mt-6">
          <DealsGrid
            ...
            loading={loading}
            error={error}
            emptyTitle="Chưa có deal hot nào"
            emptySubtitle="Hãy quay lại sau — chúng tôi cập nhật thường xuyên."
        ...
        <div className="mt-12 flex flex-col items-center gap-4 rounded-2xl p-8 text-center sm:flex-row" style={{ backgroundColor: '#fff7ed', border: '1px solid #fed7aa' }}>
          <div className="flex-1">
            <p className="text-sm font-semibold" style={{ color: '#111827' }}>
              Tìm voucher cho link sản phẩm cụ thể?
            </p>
